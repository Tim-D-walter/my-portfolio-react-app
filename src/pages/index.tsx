                    ...
                    <div className="about-container">
                        <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="study">
                                ...
                                <g id="books">
                                    <rect id="Rectangle 984" x="58" y="27" width="4" height="14" transform="rotate(90 58 27)" fill="#97a6b1" stroke="#453F3C" strokeWidth="2"/>
                                    <rect id="Rectangle 985" x="56" y="23" width="4" height="14" transform="rotate(90 56 23)" fill="#797270" stroke="#453F3C" strokeWidth="2"/>
                                    <rect id="Rectangle 986" x="60" y="19" width="4" height="14" transform="rotate(90 60 19)" fill="#06131b" stroke="#453F3C" strokeWidth="2"/>
                        ...
                        <div className="about-text-container">
                            ...
                            <p>At TimTech Solutions, we specialize in providing top-notch software development, cloud architecture and consulting services to our clients. Our team is composed of highly skilled and experienced professionals who are passionate about delivering quality work and ensuring client satisfaction.</p>
